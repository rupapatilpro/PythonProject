...
public class ParameterizationUsingTestNG {
	...
	public Object[][] testData() throws Exception {
		return UtilExcelData.getDataFromExcel(UtilExcelData.FILE_PATH, UtilExcelData.SHEET_NAME,
				UtilExcelData.TABLE_NAME);
	}
	...
	public void testCase04(String username, String password) throws Exception {
	    ...
	    try{ 
			...
			assertEquals(actualBoxMsg,UtilExcelData.EXPECT_ERROR);
